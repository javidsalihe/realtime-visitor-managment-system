                ...
                <div class="widget-content widget-content-area br-6">
                    ...
                    <form action="{{ route('users.store') }}" method="post">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="text" name="name" class="form-control" id="name" autofocus required placeholder="اسم کاربر را وارد نمایید!">
                        </div>

                        <div class="form-group mb-4">
                            <label style="color:black;" for="position">عنوان وظیفه کاربر</label>
                            <input type="text" class="form-control" name="position" id="position"  required placeholder="عنوان وظیفه کاربر را وارد نمایید!">
                        </div>

                        <div class="form-group mb-4">
                            <label style="color:black;" for="email">ایمیل آدرس کاربر</label>
                            <input type="email" class="form-control" name="email" id="email" required placeholder="ایمیل ادرس را وارد نمایید!"  onkeyup="if($(this).val()==''){ $(this).css({'text-align':'right'})} else{ $(this).css({'text-align':'left'})}">
                        </div>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <select  name="directory_id" id="directory_id"  required class="form-control selectpicker" data-live-search="true" >
                                ...
                                @foreach($directoraties as $dir)
                                    <option value="{{$dir->directorate_id }}">{{$dir->directorate_name}}</option>
                                @endforeach
                            </select>
                        </div>
